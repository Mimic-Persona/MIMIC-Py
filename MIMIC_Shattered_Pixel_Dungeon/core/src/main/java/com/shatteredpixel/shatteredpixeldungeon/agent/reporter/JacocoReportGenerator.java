...
public class JacocoReportGenerator {
    ...
    public static String generateJacocoHtmlReport(String classFilesDir, String execFilesDir, String sourceFilesDir, String outputDir) throws IOException, InterruptedException {
        ...
        if (dir.exists()) {
            System.out.println("JaCoCo HTML report " + outputDir + " is already generated. Skipping...");
            return outputDir;
        }
    ...
    public static String generateJacocoHtmlReport(String[] classFilesDirs, String execFilesDir, String[] sourceFilesDirs, String outputDir) throws IOException, InterruptedException {
        ...
        // Add each exec file to the command list
        command.add(execFilesDir + "/*.exec");

        // Add other necessary arguments
        command.add("--classfiles");
        command.addAll(Arrays.asList(classFilesDirs));

        command.add("--sourcefiles");
        command.addAll(Arrays.asList(sourceFilesDirs));
    ...
    public static String generateJacocoHtmlReport(String classFilesDir, String execFilesDir, String sourceFilesDir, String outputDir, String[] excludedDirs) throws IOException, InterruptedException {
        System.out.println("Generating JaCoCo HTML report...");

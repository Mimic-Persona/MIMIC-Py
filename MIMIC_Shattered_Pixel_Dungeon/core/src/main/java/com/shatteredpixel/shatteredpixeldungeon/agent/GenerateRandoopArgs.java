...
public class GenerateRandoopArgs {
    public static void main(String[] args) {
        Path directoryPath = Paths.get("./core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/");
        List<String> classNames = getClassNames(directoryPath);
        classNames.forEach(System.out::println);

        String fileName = "./core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/agent/myClasses.txt";
        ...
        try {
            ...
            for (String className : classNames) {
                bufferedWriter.write("com.shatteredpixel.shatteredpixeldungeon" + className + "\n");
            }

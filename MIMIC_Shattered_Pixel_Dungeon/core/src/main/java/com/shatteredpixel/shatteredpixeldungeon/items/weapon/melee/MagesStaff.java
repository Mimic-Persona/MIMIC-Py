...
public class MagesStaff extends MeleeWeapon {
	...
	public static final String ACG_ZAP = "AG_ZAP";
	...
	public void execute(Hero hero, String action) {
		...
		if (action.equals(AC_IMBUE)) {
			...
			Dungeon.prevAction.put( "action", "Imbue" );
			Dungeon.prevAction.put( "obj1", trueName() );

		} else if (action.equals(AC_ZAP) || action.equals(ACG_ZAP)){
			Dungeon.prevAction.put( "action", "Zap" );
			Dungeon.prevAction.put( "obj1", trueName() );

...
public class SPDAction extends GameAction {
	...
	public static final GameAction AGENT_MODE     = new SPDAction("agent_mode");
	public static final GameAction MANUAL_MODE     = new SPDAction("manual_mode");
	public static final GameAction MONKEY_MODE     = new SPDAction("monkey_mode");
	public static final GameAction LLM_MODE     = new SPDAction("llm_mode");
	public static final GameAction GAME_SERVER     = new SPDAction("game_server");

	public static final GameAction RESTART	  = new SPDAction("restart");
	...
	static {
		...
		defaultBindings.put( Input.Keys.B,          	SPDAction.AGENT_MODE );
		defaultBindings.put( Input.Keys.M,          	SPDAction.MANUAL_MODE );
		defaultBindings.put( Input.Keys.N,          	SPDAction.MONKEY_MODE );
		defaultBindings.put( Input.Keys.L,          	SPDAction.LLM_MODE );
		defaultBindings.put( Input.Keys.G,          	SPDAction.GAME_SERVER );

		defaultBindings.put( Input.Keys.F12,          	SPDAction.RESTART );
	}
